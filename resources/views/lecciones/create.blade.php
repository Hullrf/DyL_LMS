@extends('layouts.app')
@section('title', 'Nueva Lección - LMS DyL')
@section('content')
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow p-8">
        ...
        <form id="form-leccion" action="{{ route('lecciones.store', $modulo) }}" method="POST"
              x-data="{ tipo: '{{ old('tipo', 'texto') }}' }">
            @csrf
            ...
            <div class="mb-6" x-show="tipo !== 'video'" x-cloak>
                ...
                @error('contenido_html')<p class="form-error text-sm">{{ $message }}</p>@enderror
            </div>
...
// Rellenar con valor anterior si hay error de validación
@if(old('contenido_html'))
    quill.root.innerHTML = {!! json_encode(old('contenido_html')) !!};
@endif
