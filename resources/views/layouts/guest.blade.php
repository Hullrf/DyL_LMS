...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full">
    ...
    <body class="h-full font-sans antialiased">
        ...
        <div class="min-h-screen flex">
            ...
            <div class="hidden lg:flex lg:w-1/2 bg-dyl-navy flex-col justify-between p-12 relative overflow-hidden">
                {{-- Patrón de fondo --}}
                ...
                <a href="/" class="flex items-center gap-3 relative z-10">
                    <div class="bg-dyl-gold rounded-xl flex items-center justify-center px-2.5 h-10">
                        <span class="text-dyl-navy font-bold text-base tracking-tight">D&amp;L</span>
                    </div>
                ...
                <div class="space-y-3 relative z-10">
                    ...
                    <div class="flex items-center gap-3 text-white/70 text-sm">
                        <svg class="w-5 h-5 text-dyl-gold-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
            ...
            <div class="flex-1 flex flex-col justify-center items-center px-6 sm:px-12 lg:px-16 bg-gray-50">
                ...
                <a href="/" class="flex items-center gap-2 mb-8 lg:hidden">
                    <div class="bg-dyl-gold rounded-lg flex items-center justify-center px-2 h-9">
                        <span class="text-dyl-navy font-bold tracking-tight">D&amp;L</span>
                    </div>
                    <span class="text-dyl-navy font-bold text-lg">LMS</span>
                </a>
